...
var Modal2 = React80.forwardRef(({
  ...
  const renderBackdrop = (0, import_react64.useCallback)((backdropProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...backdropProps,
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react69.useMemo)(function() {
...
var Offcanvas = React88.forwardRef(({
  ...
  const renderBackdrop = (0, import_react70.useCallback)((backdropProps) => (0, import_jsx_runtime84.jsx)("div", {
    ...backdropProps,
...
var Overlay2 = React95.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime93.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React95.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React96.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
...
var PageItem = React97.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React97.forwardRef(({
    children,
    ...props
...
var Pagination = React98.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React99.forwardRef((props, ref) => {
...
var Placeholder = React100.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React101.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React102.forwardRef(({
  ...
  return (0, import_jsx_runtime103.jsx)("div", {
    ...
    children: React102.Children.only(children)
  });
});
...
var Spinner = React104.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React105.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React107.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var ToastFade = React114.forwardRef((props, ref) => (0, import_jsx_runtime118.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React115.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React116.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastContainer = React118.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React119.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React120.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
