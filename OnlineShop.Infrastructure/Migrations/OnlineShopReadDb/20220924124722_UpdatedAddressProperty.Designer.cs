...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopReadDb
{
    ...
    [Migration("20220924124722_UpdatedAddressProperty")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 24, 12, 47, 22, 429, DateTimeKind.Unspecified).AddTicks(8105), new TimeSpan(0, 0, 0, 0, 0)));
