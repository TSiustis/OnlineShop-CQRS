...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopReadDb
{
    ...
    [Migration("20220904111557_InitialMigration")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 4, 11, 15, 57, 784, DateTimeKind.Unspecified).AddTicks(4464), new TimeSpan(0, 0, 0, 0, 0)));
