...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopReadDb
{
    ...
    [Migration("20220924130045_UpdatedTablesAutoInsert")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 24, 13, 0, 45, 54, DateTimeKind.Unspecified).AddTicks(409), new TimeSpan(0, 0, 0, 0, 0)));
