...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopWriteDb
{
    ...
    [Migration("20220924124730_UpdatedAddressProperty")]
    partial class UpdatedAddressProperty
    {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 24, 12, 47, 29, 973, DateTimeKind.Unspecified).AddTicks(3779), new TimeSpan(0, 0, 0, 0, 0)));
