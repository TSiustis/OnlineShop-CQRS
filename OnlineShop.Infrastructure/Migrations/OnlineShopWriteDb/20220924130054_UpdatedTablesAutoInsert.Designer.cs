...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopWriteDb
{
    ...
    [Migration("20220924130054_UpdatedTablesAutoInsert")]
    partial class UpdatedTablesAutoInsert
    {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 24, 13, 0, 54, 289, DateTimeKind.Unspecified).AddTicks(1047), new TimeSpan(0, 0, 0, 0, 0)));
