...
namespace OnlineShop.Infrastructure.Migrations.OnlineShopWriteDb
{
    ...
    [Migration("20220904115358_InitialMigration")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OrderedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2022, 9, 4, 11, 53, 58, 538, DateTimeKind.Unspecified).AddTicks(7786), new TimeSpan(0, 0, 0, 0, 0)));
